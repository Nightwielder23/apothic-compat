...
/**
 * Simply Swords has no per-weapon-type item tags in 1.20.1 â€” only material-based
 * tags (iron_gear, gold_gear, â€¦) plus a catch-all "swords" tag. The mod's item IDs
