...
public final class ApothicCompatConfig {
    ...
    private static final String DEFAULT_CONTENTS = """
            # Apothic Compat â€” user-defined loot category overrides.
            #
    ...
    /** Initial application during InterModEnqueueEvent â€” uses IMC, the only path that works pre-game. */
     ...
     * any subsequent Apotheosis config reload â€” without the mirror, our entries would vanish.
     *
     ...
     * existing override (matches IMC re-send semantics) â€” restart the server to drop entries.
     */
